...
if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
  console.log("%c Coder: Tymkiv, for Rivercode ❤️", "border: 5px solid tomato;color: #000; background: #fff;padding:15px 5px;font-size: 14px;");
} else {
...
$(function () {
  ...
  objectFitImages(); // Обнаружить хеш и прокрутить к нужному блоку

  detectHash(); // Полифил для svg use xlink в IE
...
function detectHash() {
  ...
  if (hash.length > 1) {
    if (document.querySelector(hash)) {
      ...
      var offset = window.innerWidth >= 968 ? 200 : 70;
